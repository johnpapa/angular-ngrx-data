...
describe('HeroesComponent (mock effects)', () => {
  ...
  describe('class-only', () => {
    ...
    it('should delete a hero', () => {
      const {
        component, createHeroAction, dispatchSpy,
        heroReducerSpy, initialHeroes, setPersistResponses } = getInitializedComponentClass();
...
function heroesComponentClassSetup() {
  ...
  const persistSpy = spyOn(effects, 'persist').and
